...
/**
 * This is the Triangle class for a bouncing shape. It is an Observable,
 * which means that it can notifyObservers that something in the
 * Triangle has changed, and they should take appropriate actions.
 * 
...
public class Triangle extends Observable {
    ...
    private int xDelta = 9;
    private int yDelta = 9;
    private Timer timer;
